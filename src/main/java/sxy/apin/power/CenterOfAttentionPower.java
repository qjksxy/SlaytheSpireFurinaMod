...
public class CenterOfAttentionPower extends AbstractPower {
    ...
    public CenterOfAttentionPower(AbstractCreature owner, boolean upgraded) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        ...
        // 添加一大一小两张能力图
        String path128 = "sxy/apin/img/powers/power_128/power_raw_5.png";
        String path48 = "sxy/apin/img/powers/power_48/power_raw_5.png";
