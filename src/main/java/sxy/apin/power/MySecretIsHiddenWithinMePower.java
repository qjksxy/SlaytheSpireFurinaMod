...
public class MySecretIsHiddenWithinMePower extends AbstractPower {
    ...
    public MySecretIsHiddenWithinMePower(AbstractCreature owner, int amount, boolean upgraded) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        ...
        // 添加一大一小两张能力图
        String path128 = "sxy/apin/img/powers/power_128/power_raw_78.png";
        String path48 = "sxy/apin/img/powers/power_48/power_raw_78.png";
