...
public class SurintendanteChevalmarin extends CustomCard {
    ...
    private static final String IMG_PATH = "sxy/apin/img/cards/skill/card_raw_97.png";
    ...
    public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        FurinaHelper.applyPower(abstractPlayer, abstractPlayer, new Grit(abstractPlayer, this.magicNumber), this.magicNumber);
    }
}
