...
import sxy.apin.power.OusiaEmergy;

import static sxy.apin.character.Furina.Enums.FURINA_BLUE;

public class SurgingBlade extends CustomCard {
    public static final String ID = FurinaHelper.makeCardID(SurgingBlade.class.getSimpleName());
    ...
    public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new ApplyPowerAction(abstractMonster, abstractPlayer,
                        new OusiaEmergy(abstractMonster), 1));
    }

    @Override
    public AbstractCard makeCopy() {
        return new SurgingBlade();
    }
}
