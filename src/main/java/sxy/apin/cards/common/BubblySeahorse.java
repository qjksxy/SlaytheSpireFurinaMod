...
public class BubblySeahorse extends CustomCard {
    ...
    private static final String IMG_PATH = "sxy/apin/img/cards/skill/card_raw_38.png";
    ...
    public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        FurinaHelper.applyPower(abstractPlayer, abstractPlayer, new Dewdrop(abstractPlayer, 8), 8);
    }
}
